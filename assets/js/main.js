...
var _user$project$GameView$game = function (model) {
...
var _user$project$View$view = function (model) {
	var _p0 = model.state;
	if (_p0.ctor === 'InMenu') {
		return _user$project$MenuView$menu(model);
	} else {
		return _user$project$GameView$game(model);
	}
};
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Model$init, update: _user$project$Update$update, view: _user$project$View$view, subscriptions: _user$project$Update$subscriptions})();
